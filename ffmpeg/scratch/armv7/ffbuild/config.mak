...
CXX=g++
AS=xcrun -sdk iphoneos clang -Wno-error=unused-command-line-argument-hard-error-in-future
OBJCC=xcrun -sdk iphoneos clang -Wno-error=unused-command-line-argument-hard-error-in-future
LD=xcrun -sdk iphoneos clang -Wno-error=unused-command-line-argument-hard-error-in-future
DEPCC=xcrun -sdk iphoneos clang -Wno-error=unused-command-line-argument-hard-error-in-future
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=xcrun -sdk iphoneos clang -Wno-error=unused-command-line-argument-hard-error-in-future
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -DZLIB_CONST
CFLAGS=  -arch armv7 -miphoneos-version-min=9.0 -I/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/fdk-aac/include -I/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/x264/include -std=c11 -Werror=partial-availability -mdynamic-no-pic -fno-stack-check -fomit-frame-pointer -pthread  -DX264_API_IMPORTS -I/usr/local/Cellar/x264/r3011/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Oz -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch armv7 -miphoneos-version-min=9.0 -I/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/fdk-aac/include -I/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/x264/include -mdynamic-no-pic -Qunused-arguments
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=xcrun -sdk iphoneos clang -Wno-error=unused-command-line-argument-hard-error-in-future
DOXYGEN=doxygen
LDFLAGS= -arch armv7 -miphoneos-version-min=9.0 -L/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/fdk-aac/lib -L/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/x264/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
