...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-shared --enable-static --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-avdevice --disable-devices --disable-indevs --disable-outdevs --disable-debug --disable-asm --disable-x86asm --enable-small --enable-dct --enable-dwt --enable-lsp --enable-mdct --enable-rdft --enable-fft --enable-version3 --enable-nonfree --disable-filters --disable-postproc --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-bsf=hevc_mp4toannexb --disable-encoders --enable-encoder=pcm_s16le --enable-encoder=aac --enable-encoder=libvo_aacenc --disable-decoders --enable-decoder=aac --enable-decoder=mp3 --enable-decoder=pcm_s16le --disable-parsers --enable-parser=aac --disable-muxers --enable-muxer=flv --enable-muxer=mov --enable-muxer=wav --enable-muxer=adts --disable-demuxers --enable-demuxer=mov --enable-demuxer=flv --enable-demuxer=wav --enable-demuxer=aac --disable-protocols --enable-protocol=rtmp --enable-protocol=file --enable-libfdk_aac --enable-libx264 --enable-gpl --enable-cross-compile --target-os=darwin --cc='xcrun -sdk iphonesimulator clang -Wno-error=unused-command-line-argument-hard-error-in-future' --extra-cflags='-arch x86_64 -mios-simulator-version-min=9.0 -I/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/fdk-aac/include -I/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/x264/include' --extra-ldflags='-arch x86_64 -mios-simulator-version-min=9.0 -L/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/fdk-aac/lib -L/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/x264/lib' --prefix=/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/thin/x86_64
prefix=/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/thin/x86_64
...
CC_IDENT=Apple clang version 11.0.3 (clang-1103.0.32.62)
ARCH=c
INTRINSICS=none
EXTERN_PREFIX=_
CC=xcrun -sdk iphonesimulator clang -Wno-error=unused-command-line-argument-hard-error-in-future
CXX=g++
AS=xcrun -sdk iphonesimulator clang -Wno-error=unused-command-line-argument-hard-error-in-future
OBJCC=xcrun -sdk iphonesimulator clang -Wno-error=unused-command-line-argument-hard-error-in-future
LD=xcrun -sdk iphonesimulator clang -Wno-error=unused-command-line-argument-hard-error-in-future
DEPCC=xcrun -sdk iphonesimulator clang -Wno-error=unused-command-line-argument-hard-error-in-future
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=xcrun -sdk iphonesimulator clang -Wno-error=unused-command-line-argument-hard-error-in-future
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CFLAGS=  -arch x86_64 -mios-simulator-version-min=9.0 -I/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/fdk-aac/include -I/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/x264/include -std=c11 -Werror=partial-availability -fno-stack-check -fomit-frame-pointer -fPIC -pthread  -DX264_API_IMPORTS -I/usr/local/Cellar/x264/r3011/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Oz -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch x86_64 -mios-simulator-version-min=9.0 -I/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/fdk-aac/include -I/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/x264/include -fPIC -Qunused-arguments
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=xcrun -sdk iphonesimulator clang -Wno-error=unused-command-line-argument-hard-error-in-future
DOXYGEN=doxygen
LDFLAGS= -arch x86_64 -mios-simulator-version-min=9.0 -L/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/fdk-aac/lib -L/Users/weiguangmeng/ffmpegworkspace/sourceCode/ffmpeg/external-libs/x264/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -liconv -lm -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo
